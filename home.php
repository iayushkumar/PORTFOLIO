...
<html>
<head>
	<title class ="t1">Portfolio website</title>
...
<body>
	...
	<div class="hero">
		...
		<div class="content">
			<h4>Hello, I am </h4>
			<h1>Ayush <span>kumar</span></h1>
			<h3>I'am a Web Developer.</h3>
			<div class="newslatter">
				<form action = "mailto:kayush395@gmail.com" method="post" enctype ="text/plain">
	...
	<div class="contact-me">
		...
		<a class="button-two" href="#">Hire Me</a> <br> <br>
		<!-- <a href="mailto:name1@mail.com,name2@mail.com">Send mail</a> -->
		<a class="button-two" href="mailto:kayush395@gmail.com">Send Mail</a>
	</div>
